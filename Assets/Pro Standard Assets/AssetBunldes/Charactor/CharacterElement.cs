...
public class CharacterElement
{
	...
	public bool IsLoaded
	{
		get
		{
            ...
            if (m_GameObject == null)
                m_GameObject = (GameObject)WWW.assetBundle.Load("rendererobject", typeof(GameObject));

            if (m_Material == null)
                m_Material = (Material)WWW.assetBundle.Load(name, typeof(Material));

            if (m_BoneName == null)
                m_BoneName = (StringHolder)WWW.assetBundle.Load("bonenames", typeof(StringHolder));
#endif
	...
	public bool IsSkinnedMeshRenderer()
	{
        ...
        GameObject go = (GameObject)Object.Instantiate(m_GameObject);
#endif
        result = (go.renderer is SkinnedMeshRenderer);
