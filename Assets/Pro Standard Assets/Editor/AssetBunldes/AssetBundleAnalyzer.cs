...
public class AssetBundleAnalyzer : EditorWindow {
    ...
    [MenuItem("Tool/AssetBundle/Analyze")]
    ...
    void OnGUI()
    {
        ...
        if (Selection.activeObject != null) {
            ...
            if (assetPath.Contains(".assetBundles")) {
    ...
    {  
        ...
        foreach(Object loadedObj in loadedObjects) {
            ...
            string bundlePath = directory + loadedObj.name.Replace("/", ".") + "." + loadedObj.GetInstanceID() + ".assetBundles";
